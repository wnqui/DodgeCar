...
public class CollisionDetection {
	...
	public boolean outLine(Road road, Car car) {
		...
		double tmpX;
		// 左線
		tmpX = (road.leftdnY - road.leftupY) * car.getCx() + (road.leftupX - road.leftdnX) * car.getCy()
		...
		// 右線
		tmpX = (road.rightdnY - road.rightupY) * car.getCx() + (road.rightupX - road.rightdnX) * car.getCy()
